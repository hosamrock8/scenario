...
if (code.includes(targetStr) && !code.includes("handleGenerateThumbnail")) {
  ...
  // also fix existing element
  code = code.replace(/gender: character\.gender,\n\s*description: character\.description\n\s*};\n\s*} else {/g, "gender: character.gender,\n        description: character.description,\n        imageUrl: character.imageUrl || newSavedCharacters[existingIndex].imageUrl\n      };\n    } else {");
